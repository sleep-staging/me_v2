...
if training_mode == 'ss':
    ...
    ss_wandb.save('/home/vamsi81523/v2_new_models/moco_shhs//config.py')
    ss_wandb.save('/home/vamsi81523/v2_new_models/moco_shhs//trainer.py')
    ss_wandb.save('/home/vamsi81523/v2_new_models/moco_shhs//data_preprocessing/*')
    ss_wandb.save('/home/vamsi81523/v2_new_models/moco_shhs//models/*')
    print("Loading")
