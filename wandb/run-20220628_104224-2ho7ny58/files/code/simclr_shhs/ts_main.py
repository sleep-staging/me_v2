...
if training_mode == 'ss':
    name = 'simclr_shhs_diff_pj_norm'
    ss_wandb = wandb.init(project='new_baselines',name=name,notes='normalized with shhs and sleepedf(le)',save_code=True,entity='sleep-staging')
